      ...
      <div class="col-lg-12">
        ...
        -->
                ...
                <div class="row">
                  ...
                  <div class="col-md-4">
                   Facebook <input type="text" name="facebook" class="form-control" placeholder="Facebook" value="<?= $companiaDetails['facebook'] ?>" /><br>
                  </div>
                  <div class="col-md-4">
                   Instagram <input type="text" name="instagram" class="form-control" placeholder="Instagram" value="<?= $companiaDetails['instagram'] ?>" /><br>
                  </div>
                  <div class="col-md-4">
                   Youtube <input type="text" name="youtube" class="form-control" placeholder="Youtube" value="<?= $companiaDetails['youtube'] ?>" /><br>
                  </div>
                </div>
