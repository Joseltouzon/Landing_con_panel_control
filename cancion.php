			...
			<div class="kids_top_content_middle ">
				<div class="header_container ">
					<div class="l-page-width">
						<h1><?=$cancionDetails['titulo']?></h1>
						<ul id="breadcrumbs">
							<li><a href="index.php" title="Home">Home</a></li> <span class="delimiter">&gt;</span>
							<li><span class="current_crumb"><?=$cancionDetails['titulo']?></span></li>
						</ul>
					</div>
				</div>
			</div>
										...
										<div class='grid-col grid-col-12'>
											<section class='cws-widget'>
												<section class='cws_widget_content'>
													<div class='widget-title' style="text-align: center; margin-bottom: 30px;"><?=$cancionDetails['titulo']?></div>
											...
											<section class='cws-widget'>
												<section class='cws_widget_content'>
													<div class="recent_projects ">
														<h3 class="section-title">Más Canciones</h3>
														<div class="projects_carousel clearfix" data-carousel-column="4">
															...
															<div class="iso-item">
																...
																<div><a href="page-video.php?id=<?=$resultado['id']?>" class="cws_button" target="_blank">Escuchar </a></div>
															</div>
															<?}?>
														</div>
														<!--/ .projects-carousel -->
